  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Hasyim Syahputra</div>
        <div class="card-body">
          <h5 class="card-title">SMK Prestasi Prima</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        ...
        <div class="d-flex justify-content-center gap-4">
          <a href="https://github.com/Ynnn20" class="fs-3"><i class="fa-brands fa-github"></i></a>
          <a href="https://www.instagram.com/maubelisomayy/" class="fs-3"><i class="fa-brands fa-instagram"></i></a>
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Hasyim Syahputra</a></p>
        </div>
      </div>
    </footer>
